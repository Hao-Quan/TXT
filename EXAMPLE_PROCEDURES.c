...
procedure ADS_AIRCRAFT{
    ...
    FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_REPORT_PROFILE_WPT_NAME_LENGTH = dataLinkOut.ADS_PERIODIC_REPORT_PROFILE_WPT_NAME_LENGTH.Value;
    for (int u = 0; u<FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_REPORT_PROFILE_WPT_NAME_LENGTH; u++)
        FMS_Executable::aaemInter->fms2host->ADS_PERIODIC_REPORT_PROFILE_WPT_NAME[u] = dataLinkOut.FLIGHT.ADS_PERIODIC_REPORT_PROFILE_WPT_NAME[u];
        
    FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_REPORT_PROFILE_WPT_ETA_SECOND = dataLinkOut.ADS_PERIODIC_REPORT_PROFILE_WPT_ETA_SECOND.Value;
    FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_REPORT_PROFILE_WPT_ETA_MINUTE = dataLinkOut.ADS_PERIODIC_REPORT_PROFILE_WPT_ETA_MINUTE.Value;
    FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_REPORT_PROFILE_WPT_ETA_HOUR = dataLinkOut.ADS_PERIODIC_REPORT_PROFILE_WPT_ETA_HOUR.Value;
        
    FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_REPORT_PROFILE_WPT_FIXNAME_NAME_LENGTH = dataLinkOut.ADS_PERIODIC_REPORT_PROFILE_WPT_FIXNAME_NAME_LENGTH.Value;
    for (int u = 0; u<FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_REPORT_PROFILE_WPT_FIXNAME_NAME_LENGTH; u++)
        FMS_Executable::aaemInter->fms2host->ADS_PERIODIC_REPORT_PROFILE_WPT_FIXNAME_NAME[u] = dataLinkOut.FLIGHT.ADS_PERIODIC_REPORT_PROFILE_WPT_FIXNAME_NAME[u];
    
    FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_REPORT_PROFILE_WPT_FIXNAME_LAT = dataLinkOut.ADS_PERIODIC_REPORT_PROFILE_WPT_FIXNAME_LAT.Value;
    FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_REPORT_PROFILE_WPT_FIXNAME_LONG = dataLinkOut.ADS_PERIODIC_REPORT_PROFILE_WPT_FIXNAME_LONG.Value;
    
    FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_REPORT_PROFILE_WPT_NAVAID_NAME_LENGTH = dataLinkOut.ADS_PERIODIC_REPORT_PROFILE_WPT_NAVAID_NAME_LENGTH.Value;
    for (int u = 0; u<FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_REPORT_PROFILE_WPT_NAVAID_NAME_LENGTH; u++)
        FMS_Executable::aaemInter->fms2host->ADS_PERIODIC_REPORT_PROFILE_WPT_NAVAID_NAME[u] = dataLinkOut.FLIGHT.ADS_PERIODIC_REPORT_PROFILE_WPT_NAVAID_NAME[u];

    FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_REPORT_PROFILE_WPT_NAVAID_LAT = dataLinkOut.ADS_PERIODIC_REPORT_PROFILE_WPT_NAVAID_LAT.Value;
    FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_REPORT_PROFILE_WPT_NAVAID_LONG = dataLinkOut.ADS_PERIODIC_REPORT_PROFILE_WPT_NAVAID_LONG.Value;
        
    FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_REPORT_PROFILE_WPT_AIRPORT_NAME_LENGTH = dataLinkOut.ADS_PERIODIC_REPORT_PROFILE_WPT_AIRPORT_NAME_LENGTH.Value;
    for (int u = 0; u<FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_REPORT_PROFILE_WPT_AIRPORT_NAME_LENGTH; u++)
        FMS_Executable::aaemInter->fms2host->ADS_PERIODIC_REPORT_PROFILE_WPT_AIRPORT_NAME[u] = dataLinkOut.FLIGHT.ADS_PERIODIC_REPORT_PROFILE_WPT_AIRPORT_NAME[u];

    FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_REPORT_PROFILE_WPT_LATLONG_LAT = dataLinkOut.ADS_PERIODIC_REPORT_PROFILE_WPT_LATLONG_LAT.Value;
    FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_REPORT_PROFILE_WPT_LATLONG_LONG = dataLinkOut.ADS_PERIODIC_REPORT_PROFILE_WPT_LATLONG_LONG.Value;
    FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_PROFILE_METINFO_TIME_SECOND = dataLinkOut.ADS_PERIODIC_PROFILE_METINFO_TIME_SECOND.Value;
    FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_PROFILE_METINFO_TIME_MINUTE = dataLinkOut.ADS_PERIODIC_PROFILE_METINFO_TIME_MINUTE.Value;
    FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_PROFILE_METINFO_TIME_HOUR = dataLinkOut.ADS_PERIODIC_PROFILE_METINFO_TIME_HOUR.Value;
    FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_PROFILE_METINFO_WIND_SPEED_KT = dataLinkOut.ADS_PERIODIC_PROFILE_METINFO_WIND_SPEED_KT.Value;
    FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_PROFILE_METINFO_WIND_DIR = dataLinkOut.ADS_PERIODIC_PROFILE_METINFO_WIND_DIR.Value;
    FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_PROFILE_METINFO_TEMP = dataLinkOut.ADS_PERIODIC_PROFILE_METINFO_TEMP.Value;
    FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_EPP_TIME_SECOND = dataLinkOut.ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_EPP_TIME_SECOND.Value;
    FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_EPP_TIME_MINUTE = dataLinkOut.ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_EPP_TIME_MINUTE.Value;
    FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_EPP_TIME_HOUR = dataLinkOut.ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_EPP_TIME_HOUR.Value;
    FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_NUM = dataLinkOut.ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_NUM.Value;
 
    for (int u = 0; u<100; u++)
        dataLinkIn.ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_LAT[u] = FMS_Executable::aaemInter->host2Datalink->ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_LAT[u];
    
    for (int u = 0; u<100; u++)
        dataLinkIn.ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_NAME[u] = FMS_Executable::aaemInter->host2Datalink->ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_NAME[u];
        
    for (int u = 0; u<100; u++)
        dataLinkIn.ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_ETA_SECOND[u] = FMS_Executable::aaemInter->host2Datalink->ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_ETA_SECOND[u];
        
    for (int u = 0; u<100; u++)
        dataLinkIn.ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_ETA_MINUTE[u] = FMS_Executable::aaemInter->host2Datalink->ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_ETA_MINUTE[u];
    
    for (int u = 0; u<100; u++)
        dataLinkIn.ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_ETA_HOUR[u] = FMS_Executable::aaemInter->host2Datalink->ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_ETA_HOUR[u];
        
    for (int u = 0; u<100; u++)
        dataLinkIn.ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_ESTIMATED_SPEED[u] = FMS_Executable::aaemInter->host2Datalink->ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_ESTIMATED_SPEED[u];
        
    for (int u = 0; u<100; u++)
        dataLinkIn.ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_VERT_TYPE_NUM[u] = FMS_Executable::aaemInter->host2Datalink->ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_VERT_TYPE_NUM[u];
    
    for (int u = 0; u<100; u++)
        dataLinkIn.ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_VERT_TYPE[u] = FMS_Executable::aaemInter->host2Datalink->ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_VERT_TYPE[u];
    
    for (int u = 0; u<100; u++)
        dataLinkIn.ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_LATERAL_TYPE[u] = FMS_Executable::aaemInter->host2Datalink->ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_LATERAL_TYPE[u];
    
    for (int u = 0; u<100; u++)
        dataLinkIn.ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_LEVEL_CONSTR_TYPE[u] = FMS_Executable::aaemInter->host2Datalink->ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_LEVEL_CONSTR_TYPE[u];
        
    for (int u = 0; u<100; u++)
        dataLinkIn.ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_LEVEL_CONSTR[u] = FMS_Executable::aaemInter->host2Datalink->ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_LEVEL_CONSTR[u];
        
    for (int u = 0; u<100; u++)
        dataLinkIn.ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_RTA_SECOND[u] = FMS_Executable::aaemInter->host2Datalink->ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_RTA_SECOND[u];
        
    for (int u = 0; u<100; u++)
        dataLinkIn.ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_RTA_MINUTE[u] = FMS_Executable::aaemInter->host2Datalink->ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_RTA_MINUTE[u];
        
    for (int u = 0; u<100; u++)
        dataLinkIn.ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_RTA_HOUR[u] = FMS_Executable::aaemInter->host2Datalink->ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_RTA_HOUR[u];
        
    for (int u = 0; u<100; u++)
        dataLinkIn.ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_RTA_STATUS[u] = FMS_Executable::aaemInter->host2Datalink->ADS_PERIODIC_REPORT_EXTENDED_PROFILE_WPT_RTA_STATUS[u];
        
    for (int u = 0; u<100; u++)
        dataLinkIn.ADS_PERIODIC_REPORT_EXTENDED_PROFILE_GROSS_MASS[u] = FMS_Executable::aaemInter->host2Datalink->ADS_PERIODIC_REPORT_EXTENDED_PROFILE_GROSS_MASS[u];
        
    for (int u = 0; u<100; u++)
        dataLinkIn.ADS_PERIODIC_REPORT_EXTENDED_PROFILE_PRED_GROSS_MASS[u] = FMS_Executable::aaemInter->host2Datalink->ADS_PERIODIC_REPORT_EXTENDED_PROFILE_PRED_GROSS_MASS[u];
    
    for (int u = 0; u<100; u++)
        dataLinkIn.ADS_PERIODIC_REPORT_EXTENDED_PROFILE_SCHED_CLIMB_SPEED[u] = FMS_Executable::aaemInter->host2Datalink->ADS_PERIODIC_REPORT_EXTENDED_PROFILE_SCHED_CLIMB_SPEED[u];
        
    for (int u = 0; u<100; u++)
        dataLinkIn.ADS_PERIODIC_REPORT_EXTENDED_PROFILE_SCHED_DESC_SPEED[u] = FMS_Executable::aaemInter->host2Datalink->ADS_PERIODIC_REPORT_EXTENDED_PROFILE_SCHED_DESC_SPEED[u];

    FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_REPORT_ETA_MIN_SECOND = dataLinkOut.ADS_PERIODIC_REPORT_ETA_MIN_SECOND.Value;
    FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_REPORT_ETA_MIN_MINUTE = dataLinkOut.ADS_PERIODIC_REPORT_ETA_MIN_MINUTE.Value;
    FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_REPORT_ETA_MIN_HOUR = dataLinkOut.ADS_PERIODIC_REPORT_ETA_MIN_HOUR.Value;
    FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_REPORT_ETA_MAX_SECOND = dataLinkOut.ADS_PERIODIC_REPORT_ETA_MAX_SECOND.Value;
    FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_REPORT_ETA_MAX_MINUTE = dataLinkOut.ADS_PERIODIC_REPORT_ETA_MAX_MINUTE.Value;
    FMS_Executable::aaemInter->fms2DataLink->ADS_PERIODIC_REPORT_ETA_MAX_HOUR = dataLinkOut.ADS_PERIODIC_REPORT_ETA_MAX_HOUR.Value;
    FMS_Executable::aaemInter->fms2DataLink->ADS_REJECT_DETAILS = dataLinkOut.ADS_REJECT_DETAILS.Value;
    FMS_Executable::aaemInter->fms2DataLink->ADS_POSITIVE_CONTRACT = dataLinkOut.ADS_POSITIVE_CONTRACT.Value;
